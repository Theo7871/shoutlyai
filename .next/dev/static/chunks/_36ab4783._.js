        ...
        "CreateAccountPage.useEffect": ()=>{
            if (status === "authenticated" && session) {
                ...
                const sendTokenToBackend = {
                    "CreateAccountPage.useEffect.sendTokenToBackend": async ()=>{
                        try {
                ...
                }["CreateAccountPage.useEffect.sendTokenToBackend"];
                sendTokenToBackend();
            }
        }
    }["CreateAccountPage.useEffect"], [
...
_s(CreateAccountPage, "Ld+9i/gy8vrV5x2kacTHD191Rfs=", false, function() {
    return [
