...
const FILE_NAME = "shoutlyai-brand-assets.html";
const SCOPE_CLASS = "brand-assets-content";
  ...
  return (
    <main className="bg-white text-slate-900">
      ...
      {inlineScripts.map((scriptContent, index) => (
        <Script
          key={`brand-assets-inline-script-${index}`}
          id={`brand-assets-inline-script-${index}`}
