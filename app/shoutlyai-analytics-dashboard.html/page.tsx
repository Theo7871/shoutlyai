...
const FILE_NAME = "shoutlyai-analytics-dashboard.html";
const SCOPE_CLASS = "analytics-dashboard-content";
  ...
  return (
    <main className="bg-white text-slate-900">
      ...
      {inlineScripts.map((scriptContent, index) => (
        <Script
          key={`analytics-dashboard-inline-script-${index}`}
          id={`analytics-dashboard-inline-script-${index}`}
