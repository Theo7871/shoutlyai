...
const FILE_NAME = "shoutlyai-bulk-scheduling.html";
const SCOPE_CLASS = "bulk-scheduling-content";
  ...
  return (
    <main className="bg-white text-slate-900">
      ...
      {inlineScripts.map((scriptContent, index) => (
        <Script
          key={`bulk-scheduling-inline-script-${index}`}
          id={`bulk-scheduling-inline-script-${index}`}
