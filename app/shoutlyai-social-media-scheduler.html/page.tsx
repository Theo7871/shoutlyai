...
const FILE_NAME = "shoutlyai-social-media-scheduler.html";
const SCOPE_CLASS = "social-media-scheduler-content";
  ...
  return (
    <main className="bg-white text-slate-900">
      ...
      {inlineScripts.map((scriptContent, index) => (
        <Script
          key={`social-media-scheduler-inline-script-${index}`}
          id={`social-media-scheduler-inline-script-${index}`}
