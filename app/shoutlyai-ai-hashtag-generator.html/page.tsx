...
const FILE_NAME = "shoutlyai-ai-hashtag-generator.html";
const SCOPE_CLASS = "hashtag-generator-content";
  ...
  return (
    <main className="bg-white text-slate-900">
      ...
      {inlineScripts.map((scriptContent, index) => (
        <Script
          key={`hashtag-generator-inline-script-${index}`}
          id={`hashtag-generator-inline-script-${index}`}
