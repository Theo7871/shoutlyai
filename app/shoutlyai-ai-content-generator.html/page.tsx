...
const FILE_NAME = "shoutlyai-ai-content-generator.html";
const SCOPE_CLASS = "content-generator-content";
  ...
  return (
    <main className="bg-white text-slate-900">
      ...
      {inlineScripts.map((scriptContent, index) => (
        <Script
          key={`content-generator-inline-script-${index}`}
          id={`content-generator-inline-script-${index}`}
